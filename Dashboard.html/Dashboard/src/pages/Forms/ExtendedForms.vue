    ...
    <div class="row">
      <div class="col-md-4">
        <card>
          ...
          <base-input>
            <el-date-picker type="datetime" placeholder="Date Time Picker" v-model="dateTimePicker"></el-date-picker>
          </base-input>
        </card>
      </div>
      <div class="col-md-4">
        <card>
          ...
          <base-input>
            <el-date-picker type="date" placeholder="Date Picker" v-model="datePicker"></el-date-picker>
          </base-input>
        </card>
      </div>
      <div class="col-md-4">
        <card>
          ...
          <base-input>
            <el-time-select placeholder="Time Picker" v-model="timePicker"></el-time-select>
          </base-input>
        </card>
      </div>
    </div>
      ...
      <div class="col-12">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <base-progress label="Primary" :value="60" value-position="right" type="primary" />
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4">
            ...
            <image-upload type="avatar" select-text="Add photo" @change="onAvatarChange" />
          </div>
        </div>
      </div>
    </card>
